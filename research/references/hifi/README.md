...
| ![Toss](mobbin-dark-toss.webp) **Toss** | Глубокий тёмный, секции-карточки на чуть более светлом фоне (`card` vs `background`), числа разрядно (tabular), кредит-скор строкой. Близко к нашему overview dark | [mobbin](https://mobbin.com/screens/d8af309c-6543-4750-9acc-77215f009c69) |
...
| ![Crypto.com](mobbin-dark-cryptocom.webp) **Crypto.com** | Тёмно-синий фон, segmented-фильтры (24H/1W/1M — как наш RangeToggle 7/30/60), строки-обязательства с £ справа. Структура списка под overview | [mobbin](https://mobbin.com/screens/82434aa8-3646-47f3-8c93-8e7400515a3c) |
