...
const ALL_PNGS = ['onboarding-1-welcome.png','onboarding-2.png','onboarding-3-nodoc.png','onboarding-4-register.png','scan-capture.png','scan-camera-wireframe.png','scan-processing-wireframe.png','scan-review.png','decode-result-wireframe.png','ask.png','qa-signpost.png','trust-repair.png','cockpit-wireframe.png','cockpit-empty.png','vault-list.png','vault-detail.png','alerts-inbox.png','alert-detail.png','settings.png','paywall.png','error-offline.png','error-decode-failed.png','error-limit-reached.png','error-camera-denied.png','empty-no-results.png','error-purchase-failed.png']
